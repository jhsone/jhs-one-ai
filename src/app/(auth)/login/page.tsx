...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (!authLoading && session) router.push('/chat')
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      if (signInError) { setError(signInError.message); setSigningIn(false) }
    } catch (err) {
  ...
  if (authLoading || session) {
    return (
      <div className="min-h-dvh flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
    ...
    <div className="min-h-dvh flex flex-col items-center justify-center px-5 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      ...
      <div className="w-full max-w-sm relative">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2 tracking-tight">
            {t('login.title')}
          </h1>
        ...
        {error && (
          <div className="mb-4 p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 animate-in fade-in">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-100 dark:border-gray-800">
          <Button
            ...
            disabled={signingIn}
            className="w-full text-sm sm:text-base py-3 rounded-xl transition-all duration-200 active:scale-[0.98]"
          >
            {signingIn ? (
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800">
            <div className="flex items-center justify-center gap-2 text-xs text-gray-400 dark:text-gray-500">
              ...
              <span>Free • Secure • AI-powered</span>
            </div>
          </div>
        </div>
      </div>

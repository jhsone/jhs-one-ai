...
export default function LoginPage() {
  ...
  if (authLoading || session) {
    return (
      <div className="min-h-dvh flex items-center justify-center bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900">
